/*
    ...
    - objetivo 1 - quando clciar no botão de troca de tema, adicionar a classe modo-escuro no body pra que os estilos do modo escuro sejam aplicados e mudar a imagem, pra lua

      - passo 1 - pegar no JS o elemento HTML no correspondente ao botão de troca de tema
      ...
      - passo 7 - trocar de imagem do botão de alterar tema pro sol
      - passo 8 - trocar a imagem do botao de alterar tema pro sol
*/
